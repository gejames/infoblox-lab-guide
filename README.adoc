...
For reference, the playbook is here: 
[source, yaml]
----
---
...
Next, go to Resources/Job Templates, and click on image:images/tower-plus.png[] to create a new Job Template
...
image::images\tower-job-cred-type.png[]
